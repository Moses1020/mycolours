...
export class TaskService {
  ...
  // setUserTaskCollection(){
  //   let userTaskCollection = this.afs.collection('Users').doc(this.userId).collection('tasks').valueChanges();
  ...
  //       console.log(item.name);
  //       let taskActions = userTaskColRef.doc(item.id).collection('actionItems').valueChanges();
  //       userTaskColRef.doc(item.id).collection('actionItems').ref.get().then(() => {
  //         taskActions.subscribe(arr => {
  //           item.subTasks = arr;
  //           this.userstasks.push(item);
  //         })
  //       });
  //     });
