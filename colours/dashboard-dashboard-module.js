...
/* harmony import */ var app_services_project_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! app/services/project.service */ "./src/app/services/project.service.ts");
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(afAuth, router, authService, afs, ps) {
        var _this = this;
        this.afAuth = afAuth;
        this.router = router;
    ...
    //   console.log(timer);
    // }
    DashboardComponent.prototype.dataCall = function () {
        var _this = this;
        ...
        // this.showProjs = false;
        // this.hideProjs = false;
        var currentDate = moment__WEBPACK_IMPORTED_MODULE_7__(new Date()).format('L');
        ;
        var today = moment__WEBPACK_IMPORTED_MODULE_7__(new Date(), "YYYY-MM-DD");
        console.log(currentDate);
        var userDocRef = this.afs.collection('Users').doc(this.userId);
        ...
        var myProjects = userDocRef.collection('projects', function (ref) { return ref.orderBy('createdOn', "desc").limit(5); }).valueChanges();
        this.thyProjects = 0;
        myProjects.subscribe(function (projects) {
            console.log(projects);
            // console.log(this.allMyProjects);
            _this.thyProjects = projects;
        ...
        this.projsNo = 0;
        this.allMyProjects.subscribe(function (projects) {
            console.log(projects);
            console.log(_this.allMyProjects);
            _this.viewProjects = projects;
            _this.projsNo = projects.length;
            if (_this.projsNo == 0) {
                _this.showProjs = false;
                _this.hideProjs = true;
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        this.allColoursProjects = this.afs.collection('Projects', function (ref) { return ref.orderBy('createdOn', "desc").limit(10); }).valueChanges();
        this.projs2No = 0;
        this.marketProjects = [];
        this.allColoursProjects.subscribe(function (projects) {
            console.log(projects);
            _this.marketProjects = projects;
            _this.projs2No = projects.length;
            if (_this.projs2No == 0) {
                _this.showMdata = false;
                _this.hideMdata = true;
            }
            else {
                _this.showMdata = true;
                _this.hideMdata = false;
            }
        });
        var lists = document.getElementsByClassName('setLists')[0];
    ...
    DashboardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [angularfire2_auth__WEBPACK_IMPORTED_MODULE_2__["AngularFireAuth"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _services_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"], angularfire2_firestore__WEBPACK_IMPORTED_MODULE_3__["AngularFirestore"], app_services_project_service__WEBPACK_IMPORTED_MODULE_8__["ProjectService"]])
    ], DashboardComponent);
